...
data = wuml.wData(xpath='./data/D4_subset_of_D3.csv', batch_size=32, 
					label_type='continuous', label_column_name='gestationAge',
					mv_columns_to_extra_data='preterm_best',
					first_row_is_label=True)
...
#net = wuml.load_torch_network('./test_network.pk', load_as_cpu_or_gpu='cpu')
#net = wuml.load_torch_network('./gestNet.pk')
#net = wuml.load_torch_network('./gestNet_800_60p.pk')
net = wuml.load_torch_network('./D4_CE_2000_99.pk')
