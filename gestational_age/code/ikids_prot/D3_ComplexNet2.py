...
netStructureList = []
netStructureList.append([(3000,'relu'),('bn', True),(3000,'relu'),('bn', True),(3000,'relu'),('bn', True),(bottleneck_size,'none')])
...
netStructureList.append([(1000,'relu'),('bn', True),(1000,'relu'),('bn', True),(1,'none')])	#MSE objective
