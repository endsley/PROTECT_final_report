...
#	If we include the 1/0 of preterm birth info, would it help? 
...
#	Objective 1 --------------------------------------------
#fun_list = [costFunction, costFunction2, costFunction3, costFunction4, costFunction5, costFunction6, costFunction7]
