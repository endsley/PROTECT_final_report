...
keep_list = ['MEP' ,'BP3' ,'TCS' ,'PPB' ,'MIBP' ,'MPB' ,'MBP' ,'MECPP' ,'DCP25' ,'MHIBP' ,'MCOP' ,'MEOHP' ,'MEHHP' ,'TCB' ,'MBZP' ,'BPA' ,'sex' ,'MEHP' ,'MCNP' ,'BPS' ,'MHBP' ,'stress' ,'age_m' ,'BMI_prepreg' ,'income', 'preterm_best', 'gestationAge']
data = wuml.wData(xpath='./data/D3_Imputed_Balanced_regression.csv', only_keep_these_columns=keep_list, first_row_is_label=True)
data.to_csv('./data/D4_subset_of_D3.csv', add_row_indices=False, include_column_names=True, float_format='%.4f')
